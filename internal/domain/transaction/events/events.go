...
const (
	...
	TypeMoneyInvested            string = "MoneyInvested"
)
...
func (e MoneyInvested) Type() string {
	return TypeMoneyInvested
}

func (e MoneyInvested) Content() any {
	return e
}
